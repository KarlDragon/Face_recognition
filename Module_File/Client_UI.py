...
from .Client import Client  # Make sure to replace this with the correct import
...
def run_gui(queue,path,IP,port):
    root = tk.Tk()
...
if __name__ == "__main__":
    ...
    gui_thread = threading.Thread(target=run_gui, args=(frame_queue,path,IP,port,))
    gui_thread.start()
